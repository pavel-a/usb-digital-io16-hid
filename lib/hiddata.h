...
The implementation uses native HID API on Windows, Apple OS X or libusb on Linux etc.
...
Libraries to link are:
 ...
 Inspired by the work of Christian Starkjohann;
 OBJECTIVE DEVELOPMENT Software GmbH  (2008) 
 */
 ...
 * The callback can probe the device and close it or keep open and own it.
